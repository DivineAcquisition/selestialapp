    ...
    >
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-sidebar-border">
        <div className="flex items-center gap-2 overflow-hidden">
          {collapsed ? (
            <Image src="/logo-icon-new.png" alt="Selestial" width={32} height={32} className="w-8 h-8 object-contain" />
          ) : (
            <Image src="/selestial-logo.png" alt="Selestial" width={140} height={32} className="h-8 object-contain" />
          )}
        </div>
        <button
